...
$insertUser = "INSERT INTO USERS 
                ...
                'Milton', 'ON', 'L9T5E3', 'carlobeck', '$hashedPassword', 86.30, 1);";
...
$insertUser = "INSERT INTO USERS 
                ...
                'Edmonton', 'AB', 'T6N0B6', 'mtate', '$hashedPassword', 0.73, 2);";
...
$insertUser = "INSERT INTO USERS 
                ...
                'Winnipeg', 'MB', 'R3B0R6', 'dylvaughn', '$hashedPassword', 95.29, 1);";
...
$insertUser = "INSERT INTO USERS 
                ...
                'Emeryville', 'ON', 'N0R1A0', 'murrjen', '$hashedPassword', 384.53, 1);";
...
$insertUser = "INSERT INTO USERS 
                ...
                'Calgary', 'AB', 'T1Y5J4', 'scottjordan', '$hashedPassword', 1.94, 2);";
...
$insertUser = "INSERT INTO USERS 
                ...
                'Victoria', 'BC', 'V9B2P3', 'mhouston', '$hashedPassword', 0.05, 1);";
...
$insertUser = "INSERT INTO USERS 
                ...
                'St-Jerome', 'QC', 'J7Z5C2', 'castanedam', '$hashedPassword', 59.12, 1);";
...
$insertUser = "INSERT INTO USERS 
                ...
                'Port Coquitlam', 'BC', 'V3C2A5', 'vance.hazel', '$hashedPassword', 401.34, 2);";
...
$insertUser = "INSERT INTO USERS 
                ...
                'White Rock', 'BC', 'V4B3X8', 'kieran', '$hashedPassword', 49.59, 0);";
...
$insertUser = "INSERT INTO USERS 
                ...
                'Windsor', 'ON', 'N9E1E1', 'angniel', '$hashedPassword', 10.51, 2);";
